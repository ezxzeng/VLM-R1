...
export RUN_NAME="Qwen2.5-VL-3B-GRPO-TALLY-lora-ratio-cntFormR-pointsR-segR-pointAccR-cntConsR-cntAccR"
...
export RUN_NAME="Qwen2.5-VL-3B-GRPO-TALLY-lora-ratio-cntFormR-segR"
export LOG_PATH="output/$RUN_NAME/debug_log.txt"
...
export RUN_NAME="Qwen2.5-VL-3B-GRPO-TALLY-lora-ratio-pointsR"
export LOG_PATH="output/$RUN_NAME/debug_log.txt"
...
export RUN_NAME="Qwen2.5-VL-3B-GRPO-TALLY-lora-ratio-segR"
export LOG_PATH="output/$RUN_NAME/debug_log.txt"
...
export RUN_NAME="Qwen2.5-VL-3B-GRPO-TALLY-lora-ratio-pointAccR"
export LOG_PATH="output/$RUN_NAME/debug_log.txt"
...
export RUN_NAME="Qwen2.5-VL-3B-GRPO-TALLY-lora-ratio-cntConsR"
export LOG_PATH="output/$RUN_NAME/debug_log.txt"
...
export RUN_NAME="Qwen2.5-VL-3B-GRPO-TALLY-lora-ratio-cntAccR"
export LOG_PATH="output/$RUN_NAME/debug_log.txt"
